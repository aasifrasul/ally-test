...
class AnalyticsClient {
	...
	async init(options) {
		...
		if ('serviceWorker' in navigator) {
			try {
				const registration = await navigator.serviceWorker.register('/analytics-sw.js');
				console.log('Analytics Service Worker registered with scope:', registration.scope);
			} catch (error) {
